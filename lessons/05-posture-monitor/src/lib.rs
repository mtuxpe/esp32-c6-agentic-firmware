//! MPU6050/MPU9250 sensor helper functions
//!
//! Compatible with both MPU6050 and MPU9250 (same I2C interface for accel/gyro)
...
/// Wake up the MPU6050/MPU9250 from sleep mode
